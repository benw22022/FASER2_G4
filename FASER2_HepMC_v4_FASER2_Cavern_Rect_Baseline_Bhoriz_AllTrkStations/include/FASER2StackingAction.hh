...
// ********************************************************************
//
/// \file eventgenerator/HepMC/HepMCEx01/include/FASER2StackingAction.hh
/// \brief Definition of the FASER2StackingAction class
//
//

#ifndef FASER2StackingAction_H
#define FASER2StackingAction_H 1
...
class G4Track;
class FASER2StackingActionMessenger;

class FASER2StackingAction : public G4UserStackingAction {
public:
  FASER2StackingAction();
  virtual ~FASER2StackingAction();
...
private:
  ...
  FASER2TrackerHitsCollection* fTrkHits;
  FASER2MuonHitsCollection* fMuonHits;
  FASER2StackingActionMessenger* fMessenger;
