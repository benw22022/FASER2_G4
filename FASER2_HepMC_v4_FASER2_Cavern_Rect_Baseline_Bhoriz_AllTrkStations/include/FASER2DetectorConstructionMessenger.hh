...
class FASER2DetectorConstructionMessenger: public G4UImessenger {
  public:
    FASER2DetectorConstructionMessenger(FASER2DetectorConstruction*);
    ~FASER2DetectorConstructionMessenger();

    void SetNewValue(G4UIcommand*, G4String);

  private:
    FASER2DetectorConstruction* det;
