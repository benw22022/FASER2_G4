...
// ********************************************************************
//
/// \file eventgenerator/HepMC/HepMCEx01/src/FASER2StackingActionMessenger.cc
/// \brief Implementation of the FASER2StackingActionMessenger class
//
//
...
FASER2StackingActionMessenger::FASER2StackingActionMessenger
  (FASER2StackingAction * msa)
  : G4UImessenger(),
    fMyAction(msa)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void FASER2StackingActionMessenger::SetNewValue
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4String FASER2StackingActionMessenger::GetCurrentValue(G4UIcommand * command)
{
  G4String cv;
