...
// ********************************************************************
//
/// \file Rungenerator/HepMC/HepMCEx01/src/FASER2RunActionMessenger.cc
/// \brief Implementation of the FASER2RunActionMessenger class
//
//
...
FASER2RunActionMessenger::FASER2RunActionMessenger
                             (FASER2RunAction* evtAct)
  : act(evtAct)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void FASER2RunActionMessenger::SetNewValue(G4UIcommand* command, G4String newValues)
{
//   if (command==verbose) {
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4String FASER2RunActionMessenger::GetCurrentValue(G4UIcommand* command)
{
    G4String cv;
