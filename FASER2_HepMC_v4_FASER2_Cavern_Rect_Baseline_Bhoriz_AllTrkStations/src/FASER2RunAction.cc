...
// ********************************************************************
//
/// \file eventgenerator/HepMC/HepMCEx01/src/FASER2RunAction.cc
/// \brief Implementation of the FASER2RunAction class
//
//
...
FASER2RunAction::FASER2RunAction()
 : G4UserRunAction()
{
  man = G4AnalysisManager::Instance();
  messenger = new FASER2RunActionMessenger(this);
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void FASER2RunAction::BeginOfRunAction(const G4Run* aRun)
{
...
void FASER2RunAction::EndOfRunAction(const G4Run*) 
{
  man->Write();
  man->CloseFile();
}
...
G4String FASER2RunAction::GetOutputFileName() const
{
  return foutputFileName;
}


void FASER2RunAction::SetOutputFileName(G4String fname)
{
...
void FASER2RunAction::ClearHits()
{
  m_hits_x.clear();
  m_hits_y.clear();
  m_hits_z.clear();
...
std::set<G4int> FASER2RunAction::FindHitsToMerge(G4double xtol, G4double ytol) const
{
...
G4int FASER2RunAction::MergeHits(G4double xtol, G4double ytol)
{   
