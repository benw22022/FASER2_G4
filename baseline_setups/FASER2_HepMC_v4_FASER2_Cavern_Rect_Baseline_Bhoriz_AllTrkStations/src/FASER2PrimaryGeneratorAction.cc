...
// ********************************************************************
//
/// \file eventgenerator/HepMC/HepMCEx01/src/FASER2PrimaryGeneratorAction.cc
/// \brief Implementation of the FASER2PrimaryGeneratorAction class
//
//
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void FASER2PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  if(fCurrentGenerator)
    fCurrentGenerator-> GeneratePrimaryVertex(anEvent);
  else
    G4Exception("FASER2PrimaryGeneratorAction::GeneratePrimaries",
