...
def process_file_wrapper(args): 
    g4exe, hepmc, output_dir, nevents_in_file, output_queue = args 
...
def main(g4exe: str, input_dir: str, output_dir: str) -> None:
    ...
    with multiprocessing.Manager() as manager: 
        ...
        for hepmc in hepmc_files: 
            ...
            tasks.append((g4exe, hepmc, output_dir, nevents_in_file, output_queue))
        ...
        results = [output_queue.get() for _ in range(len(tasks))]
        was_success = True
