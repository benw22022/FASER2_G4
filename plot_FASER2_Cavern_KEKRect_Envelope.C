...
{
  TFile* f_F2_Cavern_New = TFile::Open("FASER2_HepMC_v4_FASER2_Cavern_Rect_KEKRect_3rdTrkStation-build/output.root");
  ...
  TH2D* h2_ep = new TH2D("h2_ep","h2_ep",100,-3000,3000,100,-3000,3000);
  t_F2_Cavern_New->Draw("ep_y:ep_x>>h2_ep","","COLZ");
  //TH2D* h2_ep = new TH2D("h2_ep","h2_ep",100,-3000,3000,100,-3000,3000);
  //t_F2_Cavern_New->Draw("ep_y:ep_x>>h2_ep","","COLZ");

  TH2D* h2_em = new TH2D("h2_em","h2_em",100,-3000,3000,100,-3000,3000);
  t_F2_Cavern_New->Draw("em_y:em_x>>h2_em","","COLZ");
  //TH2D* h2_em = new TH2D("h2_em","h2_em",100,-3000,3000,100,-3000,3000);
  //t_F2_Cavern_New->Draw("em_y:em_x>>h2_em","","COLZ");

  TH2D* h2_add = new TH2D("h2_add","h2_add",100,-3000,3000,100,-3000,3000);
  ...
  TBox* box= new TBox(-1500,-250,1500,250);
  box->SetFillStyle(0);
  ...
  */
  ...
  c1->SaveAs("FASER2_Cavern_KEKRect_Envelope.pdf")
}
