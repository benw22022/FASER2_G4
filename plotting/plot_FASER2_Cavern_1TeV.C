{
  ...
  if (doNoBField){
    f_F2_Cavern_1stTrkStation_noB = TFile::Open("FASER2_HepMC_v4_FASER2_Cavern_1stTrkStation_noB-build/output.root");
    t_F2_Cavern_1stTrkStation_noB = (TTree*)f_F2_Cavern_1stTrkStation_noB->Get("Hits");

    f_F2_Cavern_2ndTrkStation_noB = TFile::Open("FASER2_HepMC_v4_FASER2_Cavern_2ndTrkStation_noB-build/output.root");
    t_F2_Cavern_2ndTrkStation_noB = (TTree*)f_F2_Cavern_2ndTrkStation_noB->Get("Hits");
    
    f_F2_Cavern_3rdTrkStation_noB = TFile::Open("FASER2_HepMC_v4_FASER2_Cavern_3rdTrkStation_noB-build/output.root");
  ...
  t_F2_Cavern_1stTrkStation->Draw("abs(ep_y-em_y)>>h_dy_F2_Cavern_1stTrkStation","ep_E+em_E > 990 && ep_E+em_E < 1100");

  TH1F* h_dy_F2_Cavern_2ndTrkStation = new TH1F("h_dy_F2_Cavern_2ndTrkStation","h_dy_F2_Cavern_2ndTrkStation",nbins,xbins);
  t_F2_Cavern_2ndTrkStation->Draw("abs(ep_y-em_y)>>h_dy_F2_Cavern_2ndTrkStation","ep_E+em_E > 990 && ep_E+em_E < 1100");

  TH1F* h_dy_F2_Cavern_3rdTrkStation = new TH1F("h_dy_F2_Cavern_3rdTrkStation","h_dy_F2_Cavern_3rdTrkStation",nbins,xbins);
  t_F2_Cavern_3rdTrkStation->Draw("abs(ep_y-em_y)>>h_dy_F2_Cavern_3rdTrkStation","ep_E+em_E > 990 && ep_E+em_E < 1100");
  ...
  if (doNoBField){
    ...
    t_F2_Cavern_1stTrkStation_noB->Draw("abs(ep_y-em_y)>>h_dy_F2_Cavern_1stTrkStation_noB","ep_E+em_E > 990 && ep_E+em_E < 1100");

    h_dy_F2_Cavern_2ndTrkStation_noB = new TH1F("h_dy_F2_Cavern_2ndTrkStation_noB","h_dy_F2_Cavern_2ndTrkStation_noB",nbins,xbins);
    t_F2_Cavern_2ndTrkStation_noB->Draw("abs(ep_y-em_y)>>h_dy_F2_Cavern_2ndTrkStation_noB","ep_E+em_E > 990 && ep_E+em_E < 1100");
    
    h_dy_F2_Cavern_3rdTrkStation_noB = new TH1F("h_dy_F2_Cavern_3rdTrkStation_noB","h_dy_F2_Cavern_3rdTrkStation_noB",nbins,xbins);
    t_F2_Cavern_3rdTrkStation_noB->Draw("abs(ep_y-em_y)>>h_dy_F2_Cavern_3rdTrkStation_noB","ep_E+em_E > 990 && ep_E+em_E < 1100");
}
  ...
  if(doNoBField){
    ...
    leg2->AddEntry(h_dy_F2_Cavern_1stTrkStation,"B_{horiz} = 1T","l");
    leg2->AddEntry(h_dy_F2_Cavern_1stTrkStation_noB,"B_{horiz} = 0","l");
    leg2->Draw();
  }
  ...
  if(doNoBField){  
    c1->SaveAs("FASER2_Cavern_1TeV_wNoB.pdf");
  }else{
    c1->SaveAs("FASER2_Cavern_1TeV.pdf");
  }
