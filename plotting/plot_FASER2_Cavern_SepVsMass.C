{
  ...
  TString coup="1p874e-06";
  TString mass1="0p0501";
  TString mass2="0p3548";
  TString mass3="1p2589";
      
  
  TFile* f_F2_Cavern_1 = TFile::Open("FASER2_HepMC_v4_FASER2_Cavern_1stTrkStation-build/output_S2-L10-D2_mass"+mass1+"GeV_coup"+coup+".root");
  TTree* t_F2_Cavern_1 = (TTree*)f_F2_Cavern_1->Get("Hits");

  TFile* f_F2_Cavern_2 = TFile::Open("FASER2_HepMC_v4_FASER2_Cavern_1stTrkStation-build/output_S2-L10-D2_mass"+mass2+"GeV_coup"+coup+".root");
  TTree* t_F2_Cavern_2 = (TTree*)f_F2_Cavern_2->Get("Hits");

  TFile* f_F2_Cavern_3 = TFile::Open("FASER2_HepMC_v4_FASER2_Cavern_1stTrkStation-build/output_S2-L10-D2_mass"+mass3+"GeV_coup"+coup+".root");
  ...
  leg->AddEntry(h_dy_F2_Cavern_1,"m="+mass1.ReplaceAll("p",".")+" GeV, #epsilon="+coup.ReplaceAll("p","."),"l");
  leg->AddEntry(h_dy_F2_Cavern_2,"m="+mass2.ReplaceAll("p",".")+" GeV, #epsilon="+coup.ReplaceAll("p","."),"l");
  leg->AddEntry(h_dy_F2_Cavern_3,"m="+mass3.ReplaceAll("p",".")+" GeV, #epsilon="+coup.ReplaceAll("p","."),"l");
  leg->Draw();
  ...
  if(doNoBField){  
    c1->SaveAs("FASER2_Cavern_SepVsMass_wNoB.pdf");
  }else{
    c1->SaveAs("FASER2_Cavern_SepVsMass.pdf");
  }
