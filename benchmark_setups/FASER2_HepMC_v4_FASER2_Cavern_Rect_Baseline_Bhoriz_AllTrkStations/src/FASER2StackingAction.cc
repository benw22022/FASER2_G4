...
// ********************************************************************
//
/// \file eventgenerator/HepMC/HepMCEx01/src/FASER2StackingAction.cc
/// \brief Implementation of the FASER2StackingAction class
//
//
...
#include "FASER2StackingActionMessenger.hh"
#include "G4SystemOfUnits.hh"
#include "FASER2StackingAction.hh"

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
FASER2StackingAction::FASER2StackingAction()
   ...
   fTrkHits(0), fMuonHits(0), fStage(0)
{
  ...
  fReqMuon = 2;
  fReqIso = 10;
  fMessenger = new FASER2StackingActionMessenger(this);
}
...
FASER2StackingAction::ClassifyNewTrack(const G4Track * aTrack)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4bool FASER2StackingAction::InsideRoI(const G4Track * aTrack,G4double ang)
{
  if(!fMuonHits)
  { fMuonHits = (FASER2MuonHitsCollection*)GetCollection("muonCollection"); }
  if(!fMuonHits)
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4VHitsCollection* FASER2StackingAction::GetCollection(G4String colName)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void FASER2StackingAction::NewStage()
{
  fStage++;
  G4int nhits;
  if(fStage==1)
  ...
  //              in the tracker layers.
    ...
    if(!fTrkHits)
    { fTrkHits =
      (FASER2TrackerHitsCollection*)GetCollection("trackerCollection"); }
    if(!fTrkHits)
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void FASER2StackingAction::PrepareNewEvent()
{
  fStage = 0;
  fTrkHits = 0;
  fMuonHits = 0;
