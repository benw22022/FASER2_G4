...
// ********************************************************************
//
/// \file eventgenerator/HepMC/HepMCEx01/src/FASER2PrimaryGeneratorMessenger.cc
/// \brief Implementation of the FASER2PrimaryGeneratorMessenger class
//
//
...
#include "FASER2PrimaryGeneratorMessenger.hh"
#include "FASER2PrimaryGeneratorAction.hh"

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
FASER2PrimaryGeneratorMessenger::FASER2PrimaryGeneratorMessenger
                                (FASER2PrimaryGeneratorAction* genaction)
  : fPrimaryAction(genaction)
{
  fMyDetDir = new G4UIdirectory("/mydet/");
  fMyDetDir-> SetGuidance("FASER2 detector control commands.");
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void FASER2PrimaryGeneratorMessenger::SetNewValue(G4UIcommand* command,
                                              G4String newValues)
{
  if ( command == fSelect ) {
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4String FASER2PrimaryGeneratorMessenger::GetCurrentValue(G4UIcommand* command)
{
  G4String cv, st;
  if ( command == fSelect ) {
