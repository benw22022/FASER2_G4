...
// ********************************************************************
//
/// \file eventgenerator/HepMC/HepMCEx01/src/FASER2EventAction.cc
/// \brief Implementation of the FASER2EventAction class
//
//
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void FASER2EventAction::BeginOfEventAction(const G4Event*)
{ 
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void FASER2EventAction::EndOfEventAction(const G4Event* evt)
{
  ...
  FASER2TrackerHitsCollection* THC = NULL;
  FASER2CalorimeterHitsCollection* CHC = NULL;
  FASER2MuonHitsCollection* MHC = NULL;

  if( HCE ) {
    THC = (FASER2TrackerHitsCollection*)(HCE->GetHC(ftrackerCollID));
    CHC = (FASER2CalorimeterHitsCollection*)(HCE->GetHC(fcalorimeterCollID));
    MHC = (FASER2MuonHitsCollection*)(HCE->GetHC(fmuonCollID));
  }

  if( THC ) {
    G4int n_hit = THC-> entries();
    G4cout << "     " << n_hit
         << " hits are stored in FASER2TrackerHitsCollection." << G4endl;
  }

  if( CHC ) {
    G4int n_hit = CHC-> entries();
    G4cout << "     " << n_hit
         << " hits are stored in FASER2CalorimeterHitsCollection." << G4endl;
    G4double totE = 0;
  ...
  if( MHC ) {
    ...
    G4cout << "     " << n_hit
         << " hits are stored in FASER2MuonHitsCollection." << G4endl;
  }
  */
}
