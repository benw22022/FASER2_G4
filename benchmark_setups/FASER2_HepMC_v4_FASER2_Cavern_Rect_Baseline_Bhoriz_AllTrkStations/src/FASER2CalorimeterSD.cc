...
// ********************************************************************
//
/// \file eventgenerator/HepMC/HepMCEx01/src/FASER2CalorimeterSD.cc
/// \brief Implementation of the FASER2CalorimeterSD class
//
//
...
FASER2CalorimeterSD::FASER2CalorimeterSD(G4String name)
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
FASER2CalorimeterSD::~FASER2CalorimeterSD()
{
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void FASER2CalorimeterSD::Initialize(G4HCofThisEvent*)
{
  fCalCollection = new FASER2CalorimeterHitsCollection
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4bool FASER2CalorimeterSD::ProcessHits(G4Step*aStep,G4TouchableHistory*ROhist)
{
  ...
  if ( fCellID[copyIDinZ][copyIDinPhi] == -1 ) {
    FASER2CalorimeterHit* calHit =
        new FASER2CalorimeterHit(physVol->GetLogicalVolume(),
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void FASER2CalorimeterSD::EndOfEvent(G4HCofThisEvent*HCE)
{
  static G4int HCID = -1;
  if ( HCID < 0 ) {
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void FASER2CalorimeterSD::clear()
{
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void FASER2CalorimeterSD::DrawAll()
{
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void FASER2CalorimeterSD::PrintAll()
{
}
