...
G4VPhysicalVolume* ExN04DetectorConstruction::Construct()
{
  ...
  */
  ...
  G4VPhysicalVolume * SD_phys = new G4PVPlacement(0, G4ThreeVector(0,0,fmag2_locz+fmag2_dz), SD_log, "SD_phys", experimentalHall_log, false, 0);
